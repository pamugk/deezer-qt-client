...
namespace api
{
    namespace
    {
        void deserializeAlbum(QJsonObject &jsonObj, Album& albumOut)
        {
            ...
            {
                albumOut.explicitContentLyrics = deserializeExplicity(jsonObj["explicit_content_lyrics"]);
            }
            if (jsonObj.contains("explicit_content_cover"))
            {
                albumOut.explicitContentCover = deserializeExplicity(jsonObj["explicit_content_cover"]);
            }
        ...
        void deserializeTrack(QJsonObject &jsonObj, Track &trackOut)
        {
            ...
            if (jsonObj.contains("explicit_content_lyrics"))
            {
                trackOut.explicitContentLyrics = deserializeExplicity(jsonObj["explicit_content_lyrics"]);
            }
            if (jsonObj.contains("explicit_content_cover"))
            {
                trackOut.explicitContentCover = deserializeExplicity(jsonObj["explicit_content_cover"]);
            }
